...
class LinearRegression(object):
    def __init__(self, step_size, count_iterations, percent):
        ...
        self.train_x = np.genfromtxt('../resources/csv/regression/t1_linreg_x_train.csv', delimiter=',')
        self.train_y = np.genfromtxt('../resources/csv/regression/t1_linreg_y_train.csv', delimiter=',').reshape((-1, 1))
        self.test_x = np.genfromtxt('../resources/csv/regression/t1_linreg_x_test.csv', delimiter=',')
